...
public class CoordinatorService {
	...
	public List<Coordinator> getCoordinators(Map<String, String> allRequestParams) {
		...
		if (allRequestParams.isEmpty()) {
			...
			String assignedDepartments = allRequestParams.get("assignedDepartments");
			String interestedDepartments = allRequestParams.get("interestedDepartments");
			Set<Integer> coordinatorIds = coordinatorDepartmentService
					.getCoordinatorIdsByDepartments(assignedDepartments, interestedDepartments);

			if (CollectionUtils.isEmpty(coordinatorIds)
					&& (StringUtils.isNotBlank(assignedDepartments) || StringUtils.isNotBlank(interestedDepartments))) {
				return coordinators;
			}

			Specification<Coordinator> spec = new CoordinatorSpecification(coordinatorIds, allRequestParams);
