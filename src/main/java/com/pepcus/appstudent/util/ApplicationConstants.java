...
public class ApplicationConstants {
  ...
  public static final String PRESENT_MESSAGE_DAY_CONTENT="Dear {{name}}, We appreciate your presence in Shivir {{date}}. Thanks! YJSG Group.";
  ...
  public static final String ABSENT_MESSAGE_DAY_CONTENT="Dear {{name}}, We missed you in Shivir {{date}}. Please try to attend for remaining days. Thanks! YJSG Group.";
  ...
  public static final String OPTIN_OPTOUT = "optinOptOut";
