...
public class SMSUtil {
     ...
     * @throws IOException
     */
    public static void invokeSendSMSAPI(Map<String, String> queryParams) throws GeneralSecurityException, IOException {
        logger.info(
                "##### #### invokeSendSMSAPI method invoked to send SMS for contact no.: " + queryParams.get("number"));
